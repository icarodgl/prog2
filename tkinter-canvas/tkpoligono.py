...
def main():
	...
	# Cria um poligono fechado a partir das coordenadas fornecidas como entrada. As coordenadas podem ser fornecidas
	...
	# O polígono é formado por uma série de segmentos de linhas. A função sempre une o último vértice ao primeiro,
	# fechando o polígono.
	#
	...
	tela.create_polygon(100,10,150,25,200,200,300,25, width=2, fill='yellow', outline='blue')
