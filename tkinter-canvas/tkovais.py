...
def main():
	...
	# Cria uma elipse inscrita no retângulo definido pelas coordenadas x,y do canto esquerdo superior, e das 
	# coordenadas x,y do canto direito inferior.
	#
	# Para mais propriedades de ovais, leia:
	#   http://infohost.nmt.edu/tcc/help/pubs/tkinter/web/create_oval.html
	tela.create_oval(20,20,160,160,width=2,fill="red")
	tela.create_oval(80,200,140,250,width=2,fill="blue",outline='red')
	tela.create_oval(180,20,380,130,width=0,fill="cyan")
	tela.create_oval(160,200,360,250,width=2,fill="green", dash=(3,5))	
